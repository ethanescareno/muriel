const smtp = {
  address: 'recruiterq2017@gmail.com',
...
Meteor.startup(function () {
  console.log('hola');
  process.env.MAIL_URL = `smtp://${encodeURIComponent(smtp.address)}:${encodeURIComponent(smtp.password)}@${encodeURIComponent(smtp.server)}:${smtp.port}`;
})
